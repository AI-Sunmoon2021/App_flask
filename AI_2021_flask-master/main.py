...
classes = ["rare","well-done"] #분류할 class명을 정의
...
def upload_file():
    if request.method == 'POST': #request.method는 페이지에 접속 방식을 탐지하는 기능. POST여부를 판별함.
        ...
        if file and allowed_file(file.filename):
            ...
            pred_answer =  classes[predicted] + " 입니다!"
            ...
            return render_template("index1.html",file = file,answer=pred_answer) 
...
@app.route('/AI_2021_flask-master/templates/home2.html') 
def link2():
